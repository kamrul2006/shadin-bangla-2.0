...
const HeroSection = () => {
    return (
        <section
            className="relative bg-cover bg-center bg-no-repeat min-h-[90vh] md:h-screen flex items-center px-6 bg-gradient-to-br from-green-600 via-emerald-700 to-red-600"
        >
                ...
                <div className="text-center md:text-left md:ml-20 ml-0">
                    ...
                    <Fade direction="up" delay={300} triggerOnce>
                        <p className="mt-4 text-lg md:text-xl opacity-90 max-w-lg mx-auto md:mx-0">
                            ...
                            খবর, ব্লগ, আর্টিকেল ও আরও অনেক কিছু একসাথে।
                        </p>
                    </Fade>
                ...
                <div className="flex justify-center md:justify-end">
                    <Slide direction="right" delay={500} triggerOnce>
                        <img
                            ...
                            className="w-[300px] md:w-[650px] drop-shadow-2xl hover:scale-105 transition-transform duration-500"
                        />
                    </Slide>
                </div>
            </div>
